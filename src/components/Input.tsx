...
export default function Input<TFieldValues extends FieldValues = FieldValues>({
  ...
  register,
  rules,
  classNameInput = "p-3 rounded-lg w-full outline-none border border-gray-300 focus:border-gray-500 rounded-sm focus:shadow-sm",
  classNameError = "mt-1 text-red-600 min-h-[1.25rem]",
